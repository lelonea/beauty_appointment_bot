    ...
    async def run(self, callback_query: types.CallbackQuery) -> None:
        try:
            ...
            await callback_query.message.edit_text(
                "Вы успешно зарегистрированы и можете использовать опции из меню для настройки Вашего аккаунта!",
                parse_mode=types.ParseMode.MARKDOWN,
            )
        except DuplicationException:
            await callback_query.message.edit_text(
                "Вы уже зарегистрированы и можете использовать опции из меню для настройки Вашего аккаунта!",
                parse_mode=types.ParseMode.MARKDOWN,
            )
